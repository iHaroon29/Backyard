...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Indicator
    ...
    {...props}
  >
    <div className="tailwind.config.jsrelative tailwind.config.jstop-[60%] tailwind.config.jsh-2 tailwind.config.jsw-2 tailwind.config.jsrotate-45 tailwind.config.jsrounded-tl-sm tailwind.config.jsbg-slate-200 tailwind.config.jsshadow-md dark:tailwind.config.jsbg-slate-800" />
  </NavigationMenuPrimitive.Indicator>
))
